    ...
    try:
        if isinstance(response, TextMessage):
            ...
            if content.strip().startswith("[ARTICLE START]"):
                 ...
                 processed_data = {'type': 'custom', 'content': {'type': 'article', 'data': article_data}, 'author': author}
            # Check for custom rich code marker (e.g., "[RICH_CODE:python START]")
                 ...
                 try:
                     ...
                     processed_data = {'type': 'custom', 'content': {'type': 'rich_code', 'language': lang, 'data': code_data}, 'author': author}
                 except Exception:
            ...
            # Check for standard code blocks
                ...
                processed_data = {'type': 'code', 'content': code_content, 'language': lang_hint or None, 'author': author}
            ...
            # Add checks for other dict structures representing images, etc.
                 ...
                 processed_data = {'type': 'image', 'content': response.get('url'), 'author': response.get('author', 'Agent')}
        ...
        processed_data = {'type': 'error', 'content': f"⚠️ Error processing response chunk: {str(e)}", 'author': 'System'}
