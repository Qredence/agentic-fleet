...
import { createErrorStep } from "@/features/workflow/lib";
import {
  ...
  sseClient.setCallbacks({
    ...
    onComplete: () => {
      ...
      const timeoutId = setTimeout(() => {
        ...
        // Remove timeout from tracking set after execution
 ...
 * Call this when resetting or cleaning up the chat state.
 */
export function clearTransportTimeouts(): void {
