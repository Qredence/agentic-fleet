...
- Full requirements + data model live in `developers/cosmosdb_requirements.md` and `developers/cosmosdb_data_model.md`; provision the database ahead of time since AgenticFleet never creates containers automatically.
