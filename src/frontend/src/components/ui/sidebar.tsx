...
>(
  (
    ...
    const [initialOpen] = React.useState(() =>
      getInitialOpenState(defaultOpen),
    );
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Use Secure attribute only in HTTPS environments to prevent dev issues
        const secureAttr =
          typeof window !== "undefined" && window.location.protocol === "https:"
            ? "; Secure"
            : "";
        document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}${secureAttr}; SameSite=Strict`;
      },
      [setOpenProp, open],
    );
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Always show sidebar - remove hidden class that was hiding on mobile
            // Keep responsive behavior but ensure visibility
