...
@pytest.mark.asyncio
async def test_magentic_one_initialization(mock_user_session, mock_chainlit_elements, mock_env_vars, mock_openai_client):
...
@pytest.mark.asyncio
async def test_magentic_one_with_default_values(mock_user_session, mock_chainlit_elements, mock_env_vars, mock_openai_client):
