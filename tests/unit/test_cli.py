...
def test_get_app_path():
    ...
    app_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "src", "agentic_fleet", "app.py"
    )
...
def test_get_config_path_no_oauth():
    ...
    config_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "config", "config.no-oauth.toml"
    )
